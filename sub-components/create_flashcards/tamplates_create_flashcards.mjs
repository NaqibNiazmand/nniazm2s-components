    ...
    return html`
        <div id="create_flashcards_id">
            <form id="create_flashcards-form">
                ...
                <div id="body-form">
                    <label data-lang="body_form_topic">${app.text.body_form_topic}</label>
                    <input type="text" name="input_topic" id="input_topic_id"/>
                    <label class="form-label" data-lang="body_form_name">${app.text.body_form_name}</label>
                    <input type="text" name="input_name" id="input_name_id"/>
                    <label data-lang="body_form_stack">${app.text.body_form_stack} </label>
                    ...
                    <p class="info-text">
                        <mark data-lang="body_form_description_info_text">${app.text.body_form_description_info_text}
                        </mark>
                    </p>
                    <label class="form-label"
                    ...
                    <p class="info-text">
                        <mark data-lang="body_form_translation_info_text">${app.text.body_form_translation_info_text}
                        </mark>
                    </p>
                    <p class="info-text">
                        <mark data-lang="body_form_info_text_required_fields">${app.text.body_form_info_text_required_fields}
                        </mark>
                    </p>
                </div>
                <div id="footer-form">
                    <button type="button" class="button1" id="cancel_btn"  @click=${events.cancel_button} data-lang="footer_form_button_canel">
                        ${app.text.footer_form_button_canel}
                    </button>
                    <button type="button" class="button1" id="save_btn" @click=${events.save_button}
