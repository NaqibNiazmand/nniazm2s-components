...
(() => {
    const component = {
        ...
        config: {
            ...
            "html": ["ccm.load", "https://naqibniazmand.github.io/nniazm2s-components/sub-components/register/resources/template_register_from.mjs"],
            // "html": ["ccm.load", "./../register/resources/template_register_from.mjs"],
        ...
        Instance: function () {
             ...
             */
            const render = async () => {
                this.html.render(this.html.register_form(this, events), this.element);
            }
            this.start = async () => {
                render()
            };
