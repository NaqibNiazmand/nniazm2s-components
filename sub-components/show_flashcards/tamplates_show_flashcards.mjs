            ...
            <form id="show_flashcards-form">
                <div id="header-form-id">
                    ...
                    <select id="select_stack_id">
                        ...
                        <option data-lang="header_stack_private" value="${app.text.header_stack_private}"> ${app.text.header_stack_private}</option>
                        <option data-lang="header_stack_collaboration" value="${app.text.header_stack_collaboration}"> ${app.text.header_stack_collaboration}</option>
                    </select>
